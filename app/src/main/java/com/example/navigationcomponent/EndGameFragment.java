...
import com.example.navigationcomponent.databinding.FragmentEndGameBinding;
...
//                navController.navigate(R.id.action_endGameFragment_to_startGameFragment);
                ...
                NavOptions navOptions = new NavOptions.Builder()
                        .setPopUpTo(R.id.startGameFragment, true).build();  //remove all back stack fragment from history
                navController.navigate(
                        R.id.action_endGameFragment_to_startGameFragment,
                        null, navOptions
                );
            }
        });
